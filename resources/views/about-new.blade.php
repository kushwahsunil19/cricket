                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    <div class="d-flex align-items-center "> <!-- Wrap the logo and additional content in a div -->
                        <a class="navbar-brand" href="{{ asset('/') }}">
                            ...
                            <p class="l">Cricratings.com</p>
                        </a>
                        <div class="tt ml-lg-3"> <!-- Move the additional content here -->
                            <p class="o">Cricratings.com</p>
                            <span class="q">Celebrating cricket champions through a platform for ratings, rankings, awards.</span>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <p class="pr1">Sign up for our newsletter and stay up to date with the <br>latest rankings, interesting studies, and important updates.</p><br>
               <form id="signupForm" name="signupForm" action="{{route('store')}}" class="form-horizontal" method="POST">
                ...
                <button type="submit" class="btn" id="saveBtn">I WANT IN</button><br>
            </form>
