        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticModalLabel">Delete Team</h5>
                ...
                <div class="modal-footer">
                    ...
                    <form id="deleteBlog-{{ $item->id }}" action="{{ route('delete-team', ['id' => $item->id]) }}" method="GET" style="display:none;" class="d-none">
                        @csrf
                    </form>
                </div>
            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="teams_csv" id="exampleInputFile" required onchange="updateFileNameLabel()">
