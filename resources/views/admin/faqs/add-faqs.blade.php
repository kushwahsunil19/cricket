        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="faq-list">FAQS</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form method="post" id="formData" action="{{ route('add-faqs') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="mb-3">
                            ...
                            <div class="form-group">
                                <label>Answer * :</label>
                                <textarea required type="text" name="answer" row="100" class="form-control"></textarea>
                            </div>
                        </div>
